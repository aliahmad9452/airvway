    ...
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-3 text-gray-700">
                    ...
                    <li>
                      <strong>Website</strong> refers to airvway, accessible from airvway.com
                    </li>
                    <li>
                ...
                <section>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li>
                        <strong>Chrome:</strong> <a href="https://support.google.com/accounts/answer/32050" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">https://support.google.com/accounts/answer/32050</a>
                      </li>
                      <li>
                        <strong>Internet Explorer:</strong> <a href="http://support.microsoft.com/kb/278835" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">http://support.microsoft.com/kb/278835</a>
                      </li>
                      <li>
                        <strong>Firefox:</strong> <a href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored</a>
                      </li>
                      <li>
                ...
                <section>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    You can learn more about cookies here: <a href="https://www.allaboutcookies.org/" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">All About Cookies by TermsFeed</a>.
                  </p>
                </section>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">
                        By visiting: <Link href="/contact" className="text-blue-600 hover:text-blue-800 underline">www.airvway.com/contact</Link>
                      </span>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <span className="text-gray-700">
                        By phone: <a href="tel:+18777380231" className="text-blue-600 hover:text-blue-800 font-semibold">(877) 738-0231</a>
                      </span>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">
                        By mail: 8213 Almont Dr, Plano, TX 75024 United States
                      </span>
                    </div>
                  </div>
                </section>
      ...
      <div className="bg-red-600 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-6">Call our travel experts for the best deals and personalized service</p>
          <a 
            href="tel:+18777380231" 
            className="inline-flex items-center bg-white text-red-600 font-bold py-3 px-8 rounded-full text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
          >
            <img 
              src="/assets/icons/call.gif" 
              alt="Call" 
